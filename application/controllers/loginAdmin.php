...
class LoginAdmin extends CI_Controller {
    ...
    public function logearse()
	{
        ...
        $user = $this->db->get_where('usuariosadmin', array('usuario' => $_POST['username']))->result();
        ...
        if(empty($user)){
            ...
            $_SESSION['usuarioNoExisteAdmin']="";
        }else if(empty($pass)){
            echo"contraseña erronea";
            $_SESSION['wrongPassAdmin']="";
        }else if(password_verify($_POST['password'], $pass))
        {
            echo "usuario existe";
            $_SESSION['loggedInAdmin'] = $_POST['username'];
    ...
    public function registrarse()
	{
        ...
        $_SESSION['loggedInAdmin']= $_POST['usernameReg'];
